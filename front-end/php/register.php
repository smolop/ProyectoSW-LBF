...
<script>
   ...
   function ajaxpost(){
        ...
        var $rep_contrasenha = $('#rep_pass').val();
        ...
        if(file != undefined){
            ...
            if(!!file.type.match(/image.*/)){
                ...
                formData.append('contrasenha', $contrasenha);
                formData.append('rep_contrasenha', $rep_contrasenha);

                $.ajax({
                    url: "../../.back-end/php/web-services/obtener-datos-alumnos.php",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            alert('Ingresa una imagen por favor!');
        }
    }
                ...
                <table>
                    ...
                    <td>
                         <div style="margin-left: 5%; margin-bottom: 32%;">
                            <div align="left">
                                <img id="img_destino" name="img" src="../resources/img/add-image.png" alt="Tu imagen" align="center" width="256px"/>
                            </div><br/>
                            <input type="file" id="file_url" name="image" align="center" style="margin-left: 1%;"/><br/>
                        </div>
                    </td>
                    </form>
                    </tr>
