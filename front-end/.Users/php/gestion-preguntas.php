                ...
                <head>
                    ...
                    <script language="JavaScript">
                        ...
                        function ajaxpost(){
                            ...
                            var nivel = $("#lvl").val();
                            var tema = $("#tm").val();
                            var pregunta = $("#Qst").val();
                            var respuesta = $("#ans").val();
                            var incorrecta1 = $("#noAns1").val();
                            var incorrecta2 = $("#noAns2").val();
                            var incorrecta3 = $("#noAns3").val();
                            ...
                            if(file != undefined){
                                ...
                                alert('No ha ingresado ninguna imagen, por ende se guardará sin imagen');
                            }
                                    ...
                                    formData.append('correctAns', respuesta);
                                    formData.append('incorrectAns1', incorrecta1);
                                    formData.append('incorrectAns2', incorrecta2);
                                    formData.append('incorrectAns3', incorrecta3);

                                    $.ajax({
                                        url: "../../../.back-end/php/insertar-preguntas-ajax.php",
                                        type: "POST",
                                        data: formData,
                                        processData: false,
                                        contentType: false,
                                        success: function(data){
                                            $('#info_users_editing').text(data);
                                        }
                                    });
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td id="img_zone" align="top">
                                                                <div id="img_cont" align="center">
                                                                    ...
                                                                    <div align="center">
                                                                        <img id="img_destino" src="../resources/img/add-image.png" alt="Tu imagen" align="center" style="width: 256px;"/>
                                                                    </div>
                                                                    <br/>
                                                                    <input id="file_url" type="file" name="image" align="center" style="margin-left: 7%;"/><br/>
                                                                </div>
                                                            </td>
                                                    </form>
                                                    </tr>
