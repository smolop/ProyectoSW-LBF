...
if(isset($_SESSION['user'])){
    ...
    //$_SESSION['cantidad_preguntas_competicion'] = mysqli_num_rows($QueryPlay);
    ...
    if($_SESSION['temas_usados'][$tema] < 3 && $_SESSION['cantidad_preguntas_competicion'] > 0 && $_SESSION['temas_usados'][$tema] < count($arrayBD)){


        $randomNumber = rand(0, count($arrayBD)-1);

        if (in_array($arrayBD[$randomNumber], $_SESSION['no_respondidas_competicion'])) {
            ...
            $queryPlay2 = "SELECT CodPregunta, dificultad,pregunta, respuesta, no_respuesta_1, no_respuesta_2, no_respuesta_3, image FROM Preguntas WHERE tema='$tema' AND CodPregunta=$cod_pregunta";
           ...
           '.$pregunta.'
            ...
            echo '</select></br></br></br>';
              ...
              if($rowPlay2['image'] != null)
                echo '<img id="product-img" name="imagen"  height="256px" src="data:image/type;base64,'.base64_encode( $rowPlay2['image']).'"/><br/>';
